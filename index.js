...
exports.handler = async function (event, context) {
  ...
  if (newuri.indexOf('index.html') < 0 && newuri.indexOf('.png') < 0 &&
    newuri.indexOf('.xml') < 0 && newuri.indexOf('.txt') < 0 &&
    newuri.indexOf('.jpg') < 0 && newuri.indexOf('.jpeg') < 0 &&
    newuri.indexOf('.css') < 0 && newuri.indexOf('.js') < 0 &&
    newuri.indexOf('.ico') < 0 && newuri.indexOf('.ttf') < 0 &&
    newuri.indexOf('.woff') < 0 && newuri.indexOf('.woff2') < 0 &&
    newuri.indexOf('fonts') < 0) {
  ...
  let url3 =
    "https://api.caching.guru/v1/cacheFast?returnBlank=true&url=" + finalUrl;
